define(["require", "exports", "./PNG"], function (require, exports, PNG_1) {
    "use strict";
    ...
    var PNGReader = (function () {
        function PNGReader(bytes) {
            // current pointer
            this.i = 0;
            // Output object
            this.png = new PNG_1.PNG();
            this.dataChunks = [];
        ...
        PNGReader.prototype.interlaceNone = function (data) {
            ...
            var pixels = new ArrayBuffer(bpp * png.width * png.height);
            var scanline;
            var offset = 0;
