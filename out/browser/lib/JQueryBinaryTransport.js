define(["require", "exports"], function (require, exports) {
    ...
    function register() {
        ...
        $.ajaxTransport("+binary", function (options, originalOptions, jqXHR) {
            ...
            if (FormData && ((options.dataType && (options.dataType == 'binary')) || (options.data && ((ArrayBuffer && options.data instanceof ArrayBuffer) || (window.Blob && options.data instanceof Blob))))) {
                return {
...
//# sourceMappingURL=JQueryBinaryTransport.js.map